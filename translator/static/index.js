(function(){
	...
	function morse2word(morse){
		...
		if (key!=morsearr.length) return "Please add a space between two consecutive Moss passwords."
		var word=""
	...
	function word2morse(word){
		...
		if (spacelen.length>1) return "Please do not put SPACE between the letters of the alphabet. You can try a ‘-’ to represent the interval."
